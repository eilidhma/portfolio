...
`
  ...
  const ySpace = useTransform(scrollYProgress, [0, 0.25], [0, 1]);
...
const pathVariant = {
  ...
  return (
    <Cont>
        <SectionCont>
        <TitleCont>
            <BigText color={content_themes[theme].color}>Case Study:<br></br> SaveThePlate</BigText>
        </TitleCont>
      </SectionCont>
        <LeftBlock>
            ...
            <Col paddingRight='0px' paddingLeft='2vw' width='30vw'>
                <svg width="100%" height="793" viewBox="0 0 277 793" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    stroke={content_themes[theme].color} strokeWidth="2" strokeMiterlimit="10" strokeLinecap="round"
                    style={{
                        pathLength,
        ...
        <RightBlock>
            <Display ref={ref}>
                <Col paddingRight='0px' paddingLeft='12vw' width='40vw'>
                    <motion.svg width="100%" height="453" viewBox="0 0 622 453" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <motion.path 
                    ...
                    stroke={content_themes[theme].color} strokeWidth="2" strokeMiterlimit="10"
                    style={{
                        opacity: 1,
                        scaleX: -1, // Reverse direction of line animation
                    }}
