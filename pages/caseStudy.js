        ...
        <LeftBlock>
            ...
            <Col paddingRight='0px' paddingLeft='2vw' width='30vw'>
                <svg width="100%" height="793" viewBox="0 0 277 793" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    stroke={content_themes[theme].color} stroke-width="2" strokeMiterlimit="10" strokeLinecap="round"
                    style={{
                        pathLength,
        ...
        <RightBlock>
            <Display>
                <Col paddingRight='0px' paddingLeft='12vw' width='40vw'>
                    ...
                    stroke={content_themes[theme].color} stroke-width="2" strokeMiterlimit="10"
                    style={{
